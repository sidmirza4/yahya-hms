...
export default function RegisterPage() {
  ...
  const onSubmit = async (values: RegisterFormValues) => {
    try {
      ...
      const { addUser, findUserByEmail } = await import("@src/models/User");
      ...
      // Create new user with a unique ID and required fields
      const newUser = {
        id: crypto.randomUUID(),
        name: values.name,
        email: values.email,
        password: values.password, // In a real app, we would hash this
        role: values.role,
