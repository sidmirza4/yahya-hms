...
const patients: IPatient[] = [
  { name: "John Doe", email: "john@patient.com", password: "patient1", age: 35, gender: "Male" },
  { name: "Jane Smith", email: "jane@patient.com", password: "patient2", age: 28, gender: "Female" },
  { name: "Robert Johnson", email: "robert@patient.com", password: "patient3", age: 42, gender: "Male" },
  { name: "Emily Davis", email: "emily@patient.com", password: "patient4", age: 31, gender: "Female" },
  { name: "Michael Wilson", email: "michael@patient.com", password: "patient5", age: 45, gender: "Male" },
];

const doctors: IDoctor[] = [
  { name: "Dr. Sarah Miller", email: "sarah@doctor.com", password: "doctor1", specialization: "Cardiology" },
  { name: "Dr. James Brown", email: "james@doctor.com", password: "doctor2", specialization: "Neurology" },
  { name: "Dr. Lisa Taylor", email: "lisa@doctor.com", password: "doctor3", specialization: "Pediatrics" },
  { name: "Dr. David Clark", email: "david@doctor.com", password: "doctor4", specialization: "Orthopedics" },
  { name: "Dr. Jennifer White", email: "jennifer@doctor.com", password: "doctor5", specialization: "Dermatology" },
];
  ...
  try {
    ...
    for (const doctor of createdDoctors) {
      ...
      for (let day = 1; day <= 14; day++) {
        ...
        const daySlots = [...timeSlots].sort(() => 0.5 - Math.random()).slice(0, numSlots);
...
// Export sample users for the login helper modal
